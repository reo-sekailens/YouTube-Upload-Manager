...
- The Google Cloud project uses the same Desktop client ID embedded in the app and is in External/Testing mode with the signed-in account listed as a test user.
